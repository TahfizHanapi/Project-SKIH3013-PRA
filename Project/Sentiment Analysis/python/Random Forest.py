...
print("\nAccuracy on Test Set (Random Forest):", accuracy_rf)
...
while True:
    ...
    new_comment_pred_rf = rf_classifier.predict(new_comment_vectorized)
    print("Predicted Sentiment (Random Forest):", new_comment_pred_rf[0])
